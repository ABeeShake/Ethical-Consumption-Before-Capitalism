...
dir = "/Users/parandhs/Downloads/rproject/"
dir1 = dir + "ethics_csv"
og_file = 'A5_P5_phase1.csv'

#               SPLITTING large CSV file into smaller ones

data = pd.read_csv(dir1 + "/" + og_file)

k = 500     #of csv files         10 is PLACEHOLDER, REPLACE WITH NUMBER OF ROWS IN DATAFRAME
for i in range(k):
    df = data[i:(i+1)]
...
for filename in os.listdir(dir1):
    if (filename.endswith(".csv")) & (filename != og_file):
        subprocess.call(['/Library/Frameworks/R.framework/Versions/4.1/Resources/Rscript',
                         "/Users/parandhs/Downloads/rproject/topicmodeling1.R",
                         filename])
    else:
        continue
